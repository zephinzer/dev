...
func (s *UnzipTests) TestUnzip_noEvents() {
	defer func() {
		r := recover()
		s.Nil(r)
	}()
...
func (s *UnzipTests) TestUnzip_invalidInputPath() {
	defer func() {
		r := recover()
		s.Nil(r)
	}()
...
func (s *UnzipTests) TestUnzipStatus_GetPercentDoneByBytes() {
	us := UnzipStatus{BytesTotal: 2, BytesProcessed: 1}
...
func (s *UnzipTests) TestUnzipStatus_GetPercentDoneByFiles() {
	us := UnzipStatus{FilesTotalCount: 2, FilesProcessedCount: 1}
